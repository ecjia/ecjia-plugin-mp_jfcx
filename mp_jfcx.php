...
class plugin_mp_jfcx {
    ...
    public static function adapter_instance($instance, $config) {
        ...
        $wechat = new mp_jfcx($config);
        return $wechat;
    }
}

RC_Plugin::register_activation_hook(__FILE__, array('plugin_mp_jfcx', 'install'));
RC_Plugin::register_deactivation_hook(__FILE__, array('plugin_mp_jfcx', 'uninstall'));
RC_Hook::add_filter('platform_factory_adapter_instance', array( 'plugin_mp_jfcx', 'adapter_instance' ), 10, 2);
// end